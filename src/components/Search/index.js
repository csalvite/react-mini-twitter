...
const Search = ({ tweets, setTweets }) => {
  const handleFormSubmit = (e) => {
    e.preventDefault();

    console.log('Valor del input: ', e.target.tweet.value);
    setTweets([
      ...tweets,
      {
    ...
    document.querySelector('#new-tweet').reset();
  };

  return (
    <form id='new-tweet' onSubmit={handleFormSubmit}>
